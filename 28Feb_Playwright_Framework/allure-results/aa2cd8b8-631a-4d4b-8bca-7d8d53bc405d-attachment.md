...
- Location: tests/E2E/e2e.spec.js:34:1

# Error details

```
Error: locator.isVisible: Error: strict mode violation: locator('a[href="index.html"]') resolved to 2 elements:
    1) <a id="nava" href="index.html" class="navbar-brand">…</a> aka getByRole('link', { name: 'PRODUCT STORE' })
    2) <a class="nav-link" href="index.html">…</a> aka getByRole('link', { name: 'Home (current)' })

Call log:
    - checking visibility of locator('a[href="index.html"]')
